...
// console.log('env var is '+ process.env.ENGINE_URL)
...
//   axios.post(`${engineUrl}/api/v1/execute`, {
//     code: {
...
//         const executionResults = response.data.run.output;
//         console.log(executionResults);
//         // let executionResultsArr = {};
//         // try {
//         //   executionResultsArr = JSON.parse(executionResults);
//         //   console.log(executionResultsArr);
//         // } catch (error) {
//         //   console.error('Failed to parse JSON', error);
//         //   console.log('Faulty JSON:', executionResults);
//         // }
//         // let passed = 0;
